...
save("results.jld2", Dict("results" => results))
...
coeffs = P \ results["C"]
#
pot2 = JuLIP.MLIPs.SumIP(limited_Vref, JuLIP.MLIPs.combine(combined_basis, coeffs)) 
#
include("../alt_linear_errors.jl")
alt_linear_errors(test_data, pot2; energy_per_atom=false)
