...
command(lmp, "fix storedd all store/state 1 c_dd")
command(lmp, "fix storedd all store/state 1 c_dd[49]")
...
command(lmp,"variable vdd atom f_storedd")
...
#@show sorted_dd[5,49]
#testvar = LAMMPS.extract_variable(lmp, "vdd")
