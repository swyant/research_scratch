...
def main():
    ...
    configs = read('mace_xyz_trainval_no-rd/mace_trainval_no-rd.xyz', index=':')
    print(f"Total configurations: {len(configs)}")
    
    # Read training indices
    print("\nReading training indices...")
    train_indices = read_indices('al-al2o3_dpp_trainval_indices_400.txt')
    ...
    write('400_dpp_trainval_no-rd.xyz', train_configs)
