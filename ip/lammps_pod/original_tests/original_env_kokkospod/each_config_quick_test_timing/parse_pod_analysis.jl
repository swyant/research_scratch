...
hfo2_lbp = LBasisPotential(lmp_pod,"../lammps_fit_quick_test_set/ref_quick_test_HfO2_coefficients.pod")

header=[:config, :num_atoms, :volume, :energy, :DFT_energy, :energy_error, :force, :DFT_force, :force_error]
ddict = read_segmented_files("../lammps_fit_quick_test_set/ref_quick_test_HfO2_training_analysis.pod"; header=header, delim=' ', ignorerepeated=true, skipto=2)
