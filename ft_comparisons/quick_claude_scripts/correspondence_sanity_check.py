...
def main():
    ...
    # I'm aware of how silly it is to change these defaults rather than just pass the argument, I'm doing it for my own record 
    parser.add_argument('--processed-dir', type=str, default='processed_and_split_high-force-rm',
                       help='Base directory containing processed files (default: processed_and_split_high-force-rm)')
