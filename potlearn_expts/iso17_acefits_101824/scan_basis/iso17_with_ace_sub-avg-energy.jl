...
ds_dict = load("small_iso17_dataset.jld2")

base_ds_train = ds_dict["ds_train"]
base_ds_test  = ds_dict["ds_test"]
...
for spec in ace_specs
    ...
    #edescr_train = compute_local_descriptors(base_ds_train, ace)
    #fdescr_train = compute_force_descriptors(base_ds_train, ace)
    #ds_train = DataSet(base_ds_train .+ edescr_train .+ fdescr_train)
...
save("summary_of_ace_basis_scan_iso17.jld2", Dict("ddict" => ddict))
