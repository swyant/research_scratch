...
combined_basis = ACE1x.ace_basis(elements    = elements,
                           ...
                           rin         = 0.77,
                           r0          = :bondlen,
                           #totaldegree = Dict(1 => 8, 2 => 8, 3 => 8, 4 => 8),
                           totaldegree = Dict(1 => 10, 2 => 10, 3 => 10, 4 => 8),
                           wL          = 2.0,
...
#save("design_matrix_v3.jld2", Dict("A" => A, "Y" => Y, "W" => W))
save("design_matrix_v4.jld2", Dict("A" => A, "Y" => Y, "W" => W))
#ddict = load("./design_matrix_v2.jld2")   
...
save("results_v4.jld2", Dict("results" => results))
...
coeffs = P \ results["C"]
#
pot4 = JuLIP.MLIPs.SumIP(limited_Vref, JuLIP.MLIPs.combine(combined_basis, coeffs)) 
#
include("../alt_linear_errors.jl")
alt_linear_errors(test_data, pot4; energy_per_atom=false)
